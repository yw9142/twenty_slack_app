...
import { SAVE_EXECUTION_REPORT_FUNCTION_UNIVERSAL_IDENTIFIER } from 'src/constants/universal-identifiers';
...
export default defineLogicFunction({
  universalIdentifier: SAVE_EXECUTION_REPORT_FUNCTION_UNIVERSAL_IDENTIFIER,
  name: 'save-execution-report',
  description: 'Stores an applied execution report for the Codex runner',
  timeoutSeconds: 10,
  handler,
  httpRouteTriggerSettings: {
    path: '/tools/save-execution-report',
    httpMethod: 'POST',
